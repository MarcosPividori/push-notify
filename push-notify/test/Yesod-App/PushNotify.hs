...
instance IsPushResult GCMresult where
    ...
    ,   unRegistered = map GCM                       $ errorUnRegistered r
...
send man config notif devices = do
                ...
                r1 <- if gcmDevices == []
                              then return def
                               ...
                               case gcmAppConfig config of
                                Just cnf -> case (gcmNotif  notif) of
                                              Just msg -> do
                ...
                r2 <- if apnsDevices == []
                              then return def
                               ...
                               case apnsAppConfig config of
                                Just apnsman -> case (apnsNotif notif) of
                                              Just msg -> do
                ...
                r3 <- if mpnsDevices == []
                              then return def
                               ...
                               case mpnsAppConfig config of
                                Just cnf -> case (mpnsNotif notif) of
                                              Just msg -> do
