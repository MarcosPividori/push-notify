...
getClient :: Text -> WebUsers -> Maybe (TChan MsgFromPlayer,POSIXTime)
getClient = HM.lookup

addClient :: Text -> TChan MsgFromPlayer -> POSIXTime -> WebUsers -> WebUsers
addClient t a1 a2 = HM.insert t (a1,a2)

getClients :: WebUsers -> [Text]
getClients = HM.keys

getClientsElems :: WebUsers -> [(TChan MsgFromPlayer,POSIXTime)]
getClientsElems = HM.elems

filterClients :: ((TChan MsgFromPlayer,POSIXTime) -> Bool) -> WebUsers -> WebUsers
